...
const { getTables, updateTableStatus, getWaiters, registerWaiter, deleteWaiter, updateOrderItem, generateTableSessionToken, clearTableSessionToken } = require("../controllers/waiter.controller");
...
router.post("/clear-session-token-table", authenticate, checkRole("waiter"), clearTableSessionToken);
